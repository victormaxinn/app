...
if(isset( $_GET['txtID'] )){
  ...
  $edad=$registro["edad"];
  $curp=$registro["curp"];
  $gradoestudios=$registro["gradoestudios"];
  $nombramiento=$registro["nombramiento"];
  $cicloadministracion=$registro["cicloadministracion"];
  $celular=$registro["celular"];
  $domicilio=$registro["domicilio"];
  $entidadfederativaclave=$registro["entidadfederativaclave"];
  $municipioclave=$registro["municipioclave"];
  $oficialiaclave=$registro["oficialiaclave"];
  $telefonolada=$registro["telefonolada"];
  $correogubernamental=$registro["correogubernamental"];
...
if($_POST){
  ...
  SET
      ...
      cicloadministracion=:cicloadministracion,
      celular=:celular,
      domicilio=:domicilio,
      entidadfederativaclave=:entidadfederativaclave,
      municipioclave=:municipioclave,
      oficialiaclave=:oficialiaclave,
      telefonolada=:telefonolada,
      correogubernamental=:correogubernamental,
      idpuesto=:idpuesto,
...
<div class="card">
  ...
  <input type="text"
    ...
    <div class="mb-3">
      ...
      type="date" class="form-control" name="fechanacimiento" id="fechanacimiento" aria-describedby="emailHelpId" placeholder="Fecha nacimiento">
    ...
    <div class="mb-3">
      ...
      <input type="text"
      value="<?php echo $cicloadministracion;?>"
    ...
    <div class="mb-3">
      ...
      <input type="text"
      value="<?php echo $entidadfederativaclave;?>"
    ...
    <div class="mb-3">
      ...
      <input type="text"
       value="<?php echo $correogubernamental;?>"
  ...
  <input value="<?php echo $fechaingreso;?>"
   type="date" class="form-control" name="fechaingreso" id="fechaingreso" aria-describedby="emailHelpId" placeholder="Fecha ingreso">
